    ...
    private Observable<Object> updateHomeVisitAsEvent(final long value) {
        return Observable.create(new ObservableOnSubscribe<Object>() {
            ...
            public void subscribe(ObservableEmitter<Object> e) throws Exception {
                final String homeVisitId = org.smartregister.hf.util.JsonFormUtils.generateRandomUUIDString();
...
**/
    ...
    public void updateChildCommonPerson(String baseEntityId) {
        String query = ChildUtils.mainSelect(org.smartregister.hf.util.Constants.TABLE_NAME.CHILD, org.smartregister.hf.util.Constants.TABLE_NAME.FAMILY, org.smartregister.hf.util.Constants.TABLE_NAME.FAMILY_MEMBER, baseEntityId);

        Cursor cursor = null;
        try {
            cursor = getCommonRepository(org.smartregister.hf.util.Constants.TABLE_NAME.CHILD).rawCustomQueryForAdapter(query);
            if (cursor != null && cursor.moveToFirst()) {
                CommonPersonObject personObject = getCommonRepository(org.smartregister.hf.util.Constants.TABLE_NAME.CHILD).readAllcommonforCursorAdapter(cursor);
        ...
        try {
            ...
            if (form != null) {
                ...
                if (StringUtils.isNotBlank(title)) {
                    stepOne.put(org.smartregister.hf.util.JsonFormUtils.TITLE, title);
                }
    ...
    private void processPopulatableFields(CommonPersonObjectClient client, JSONObject jsonObject, JSONArray jsonArray) throws JSONException {
        ...
        switch (jsonObject.getString(JsonFormUtils.KEY).toLowerCase()) {
            ...
            case "age": {
                ...
                String dobString = org.smartregister.hf.util.Utils.getValue(client.getColumnmaps(), DBConstants.KEY.DOB, false);
            ...
            case DBConstants.KEY.DOB:
                ...
                if (StringUtils.isNotBlank(dobString)) {
                    ...
                    if (dob != null) {
                        jsonObject.put(JsonFormUtils.VALUE, org.smartregister.hf.util.JsonFormUtils.dd_MM_yyyy.format(dob));
                    }
                }
