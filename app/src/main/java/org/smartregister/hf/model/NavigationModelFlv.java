...
public class NavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0 ) {
            ...
            //NavigationOption opt2 = new NavigationOption(R.drawable.icon_referral_warning, 0, R.string.menu_hf_referrals, Constants.DrawerMenu.REFERRALS, 0);

            navigationOptions.addAll(asList(opt1));
        }
