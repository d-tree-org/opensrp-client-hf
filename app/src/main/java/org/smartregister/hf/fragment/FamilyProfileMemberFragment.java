...
import org.smartregister.hf.activity.AboveFiveChildProfileActivity;
import org.smartregister.hf.activity.ChildProfileActivity;
...
public class FamilyProfileMemberFragment extends BaseFamilyProfileMemberFragment {
    ...
    public void goToProfileActivity(android.view.View view) {
        if (view.getTag() instanceof CommonPersonObjectClient) {
            ...
            if (org.smartregister.hf.util.Constants.TABLE_NAME.FAMILY_MEMBER.equals(entityType)) {
