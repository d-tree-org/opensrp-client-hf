...
import org.smartregister.hf.model.FamilyProfileActivityModel;
import org.smartregister.hf.presenter.FamilyProfileActivityPresenter;
import org.smartregister.hf.provider.FamilyActivityRegisterProvider;
...
/**
        ...
        searchBarLayout.setPadding(searchBarLayout.getPaddingLeft(), searchBarLayout.getPaddingTop(), searchBarLayout.getPaddingRight(), (int) org.smartregister.hf.util.Utils.convertDpToPixel(10, getActivity()));
